  ...
  "Employee",
  {
    ...
    dateOfBirth: {
      ...
      validate: {
        ...
        isBefore: {
          args: new Date().toISOString().split("T")[0], // Use YYYY-MM-DD format for dateonly comparison
      ...
      validate: {
        isValid(value) {
          if (
            ...
            throw new Error("Passport number must be 7-15 characters");
          }
        },
      },
    },
    ...
    jobTitleId: {
      ...
      allowNull: false,
      references: {
        model: JobTitle, // Assuming JobTitle model is defined elsewhere
        key: "id",
      },
      validate: {
        notNull: {
      ...
      validate: {
        ...
        requiredForCertainTypes(value) {
          ...
          if (requiresEndDate.includes(this.employmentType) && !value) {
            throw new Error(
              `End date is required for ${this.employmentType} employees`
            );
          }
        },
      },
    ...
    unitsWorked: {
      ...
      validate: {
        ...
        requiredForNonMonthlyPayment(value) {
          if (
            this.modeOfPayment !== "monthly" &&
            (value === null || value === undefined)
          ) {
            throw new Error(
              `Units worked is required for ${this.modeOfPayment} payment mode`
            );
          }
        },
      },
      ...
      validate: {
        ...
        lessThanAccumulated(value) {
          if (value > this.accumulatedLeaveDays) {
            throw new Error(
              "Utilized leave days cannot exceed accumulated leave days"
            );
          }
        },
      },
    ...
    isEligibleForLeave: {
      ...
      get() {
        return ["Permanent", "Full-Time", "Regular"].includes(
          this.employmentType
        );
      },
    },
    ...
    accountName: {
      ...
      validate: {
        ...
        requiredIfBankOrCheque(value) {
          if (
            ["bank", "cheque"].includes(this.paymentMethod) &&
            (value === null || value === undefined || value === "")
          ) {
            throw new Error(
              "Account name is required for bank and cheque payments"
            );
          }
        },
      },
      ...
      validate: {
        ...
        requiredIfBankOrCheque(value) {
          if (
            ...
            throw new Error(
              "Account number is required for bank and cheque payments"
            );
          }
        },
      },
      ...
      validate: {
        ...
        requiredIfBankOrCheque(value) {
          if (
            ...
            throw new Error(
              "Bank code is required for bank and cheque payments"
            );
          }
        },
      },
      ...
      validate: {
        ...
        requiredIfBankOrCheque(value) {
          if (
            ...
            throw new Error(
              "Branch name is required for bank and cheque payments"
            );
          }
        },
      },
      ...
      validate: {
        ...
        requiredIfBankOrCheque(value) {
          if (
            ...
            throw new Error(
              "Branch code is required for bank and cheque payments"
            );
          }
        },
      },
      ...
      validate: {
        ...
        requiredIfMobileMoney(value) {
          if (
            ...
            throw new Error(
              "Mobile number is required for mobileMoney payments"
            );
          }
        },
      },
    ...
    workPhone: {
      ...
      validate: {
        isNumeric: {
          msg: "Work number must contain only numbers",
          args: true,
          skipIfNull: true,
        },
        len: {
          args: [7, 15],
          msg: "Work number must be between 7 and 15 digits",
          skipIfNull: true,
        },
        isValidPhone(value) {
          ...
          if (!/^\+?[0-9\s-]+$/.test(value)) {
            throw new Error("Invalid work number format");
          }
        },
      },
    },
    ...
    kraPin: {
      ...
      validate: {
        notEmpty: {
          msg: "KRA PIN is required",
        },
        is: {
          args: /^[A-Z0-9]{11}$/,
          msg: "Please enter a valid KRA PIN (11 characters, uppercase alphanumeric)",
        },
      },
    },
    nssfNo: {
      ...
      validate: {
        notEmpty: {
          msg: "NSSF No is required",
        },
        isNumeric: {
          msg: "NSSF No should contain only numbers",
        },
        len: {
          args: [10, 12],
          msg: "NSSF No should be 10-12 digits long",
        },
      },
    },
    shaNo: {
      ...
      validate: {
        notEmpty: {
          msg: "SHIF No is required",
        },
        is: {
          args: /^CR\d{8,16}-\d$/,
          msg: "SHIF No format: CRxxxxxxx-x (e.g., CR647378735-8)",
        },
        len: {
          args: [12, 20], // Adjusted from 10 to 12 as per example format
          msg: "SHIF No should be between 12 and 20 characters long",
        },
      },
    },
    createdAt: {
  ...
  },
  {
    hooks: {
      beforeValidate: (employee) => {
        if (
          ["bank", "cheque"].includes(employee.paymentMethod) &&
          !employee.accountName
        ) {
          employee.accountName = `${employee.firstName} ${
            employee.middleName || ""
    ...
    indexes: [
      {
        ...
        unique: true,
        name: "unique_work_email_per_company",
      },
      {
        fields: ["companyId", "nationalId"],
        unique: true,
        name: "unique_national_id_per_company",
      },
      {
        fields: ["companyId", "staffNo"],
        unique: true,
        name: "unique_staff_no_per_company",
      },
      {
        fields: ["companyId", "taxCertificateNo"],
        unique: true,
        name: "unique_tax_certificate_no_per_company",
      },
      {
        fields: ["companyId", "accountName"],
        unique: true,
        name: "unique_account_name_per_company",
      },
      {
        fields: ["companyId", "accountNumber"],
        unique: true,
        name: "unique_account_number_per_company",
      }, // Added for robustness
      {
        fields: ["companyId", "mobileNumber"],
        unique: true,
        name: "unique_mobile_number_per_company",
      },
      {
        fields: ["companyId", "personalEmail"],
        unique: true,
        name: "unique_personal_email_per_company",
      },
      {
        fields: ["companyId", "workPhone"],
        unique: true,
        name: "unique_work_phone_per_company",
      },
      {
        fields: ["companyId", "kraPin"],
        unique: true,
        name: "unique_kra_pin_per_company",
      },
      {
        fields: ["companyId", "nssfNo"],
        unique: true,
        name: "unique_nssf_no_per_company",
      },
      {
        fields: ["companyId", "shaNo"],
        unique: true,
        name: "unique_sha_no_per_company",
      },
    ],
  }
);
...
function calculateEmployeeDetails(employee) {
  ...
  if (employee.modeOfPayment === "monthly") {
    ...
    employee.basicSalary =
      (employee.amountPerRate || 0) * (employee.unitsWorked || 0);
  }
  ...
  if (["Permanent", "Full-Time", "Regular"].includes(employee.employmentType)) {
    ...
    let lastLeaveResetDate = employee.lastLeaveReset
      ? new Date(employee.lastLeaveReset)
    ...
    employee.accumulatedLeaveDays = Math.max(
      0,
      accruedLeaveSinceLastReset - employee.utilizedLeaveDays
    );

    // Round to 2 decimal places
    employee.accumulatedLeaveDays = parseFloat(
      employee.accumulatedLeaveDays.toFixed(2)
    );
  } else {
